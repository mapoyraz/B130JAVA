...
public class Switch01 {
    ...
    public static void main(String[] args) {
        ...
        //Example 1: Ay numarasini soyleyince numrasini verilen aydan basalyip 12.aya kadar tum aylarin isimelerini
        //             yazdiran kodu yaziniz.
        //           8==> August - September -


        Scanner input = new Scanner(System.in);
        System.out.println("Baslangic ayinin kacinci ay olduğunu giriniz");
