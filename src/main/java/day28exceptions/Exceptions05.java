...
public class Exceptions05 {
    ...
    //Coklu "catch" kullandiginizda Exception Class'lar arasinda "parent - child" iliskisi yoksa, catch'lerin sirasi önemli değildir.
    //Ama kod'daki siralamaya uymak taviye edilir.
    //Coklu "catch" kullandiginizda Exception Class'lar arasinda "parent - child" iliskisi varsa, catch'lerin sirasi önemlidir, child olan class ustte olmalidir.
