...
public class Lists04 {
    ...
    public static void main(String[] args) {
        ...
        //names.subList(1, 4) "names" Listindeki index'i 1, 2 ve 3 olan elemanları bir List'in icinde size verir.
        // Ikinci index olan 4 dahil olmaz.
        List<String>subList=names.subList(1,4);
        System.out.println(subList);//[Cuneyt, Mehsun, Muslum]
        ...
        //           Elelktronik ev aletlerini listeleyiniz.
