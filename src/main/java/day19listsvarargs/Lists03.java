...
public class Lists03 {
    ...
    */
        ...
        // Dolasiyla bu sorunun cozumunde ihtiayaciniz olan Listi "Arrays.asList()" kullanarak olusturmamalisiniz.
        ...
        do {
            ...
            System.out.println("Luten 1 ile 10 arasinda bir tam sayi giriniz");
            num = input.next();

            if(numsList.contains(num)){
                numsList.set(numsList.indexOf(num), "BİNGO");
