...
public class C01_StringManipulations {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ikiyuzkirk"+40*6);//ikiyuzkirk240 işlem öncelği vardir ilk çarpmayı yapar
        System.out.println(60+40+"Yuz");//100Yuz görürüz soldan sağa çalışır.


        //Kullanicadan isim soy isim girmesini isteyin, Kullanici nasıl girerse girsin tam isminin buyuk harfle yazılmasını saglayınız.
        ...
        //Verilen cumleyi * ile gizleyip, 10uncu karakterden sonrasını yazdırın.

        String cumle= "Her dert Java gibi olsa";

        System.out.println(cumle.substring(0,10).replaceAll("\\w", "*") + cumle.substring(10));
        ...
        // str3=str3.replaceAll("\\d","").replaceAll("\\s","").replaceAll(" ","").replaceAll("\\W","");
